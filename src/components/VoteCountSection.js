...
const VoteCountSection = ({ yes, no, contested, total, neededToWin }) => {
  ...
  return (
    <>
      ...
      <p className="note">
        The code and design from this graphic was adapted from the{' '}
        <a href="https://nytimesguild.org/">The Times Tech Guild's</a> vote
        tracker.
      </p>
    </>
  );
