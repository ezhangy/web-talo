...
const HomePage = () => (
  <>
    <Helmet>
      <title>Brown CS TA Labor Organization</title>
      <meta
        name="description"
    ...
    <main name="maincontent" id="maincontent" className="HomePage page-body">
      <div id="header-wrapper">
        ...
        <div id="title-wrapper">
          ...
          <p>
            The Teaching Assistant Labor Organization (TALO) represents
            Undergraduate Teaching Assistants in the Computer Science department
            at Brown.
          </p>
        </div>
      </div>
      ...
      <div className="section-wrapper">
        ...
        <p>
          Undergraduate TAs in the CS Department are filing for unionization and
          seeking recognition from Brown. We are seeking{' '}
          <strong>higher wages</strong>,{' '}
          <strong>better working conditions</strong>, and a{' '}
          <strong> more inclusive workplace</strong>.
        </p>
